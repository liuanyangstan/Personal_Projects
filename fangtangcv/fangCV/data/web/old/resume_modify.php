...
<body>
    <div class="container">
        ...
        <form action="resume_update.php" method="post" id="form_resume" onsubmit="send_form('form_resume');return false;">
            ...
            <p><textarea name="content" placeholder="写入简历内容，支持 Markdown 语法" class="full"><?=htmlspecialchars( $resume['content'] ) ?></textarea></p>

            <input type="hidden" name="id" value="<?=$resume['id']?>"/>
            <p><input type="submit" value="更新简历" class="middle-button">
            <input type="button" value="返回" class="middle-button cancel-button" onClick="history.back(1);void(0);">
            </p>
